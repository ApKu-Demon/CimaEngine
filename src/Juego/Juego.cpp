...
namespace IVJ
{
    ...
    void Juego::OnInit(void)
    {
        ...
        /*  Descomentar este y camaras para Lab4 - - - Descomentar este y el de mas abajo para Epidemia
        // LAB 2
        std::cout<<"\n";
    ...
    void Juego::OnUpdate(float dt)
    {
        ...
        /*  Descomentar esto para lab4 y epidemia
        // LAB 3
    ...
    void Juego::OnRender(float dt)
    {
        ...
        /*  Descomentar para lab4 y epidemia
        for (auto& obj : objetos)
        {     
